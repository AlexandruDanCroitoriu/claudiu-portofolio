  ...
  <section ref="sectionRef" class="relative bg-amber-50 text-zinc-900 min-h-screen flex items-center overflow-hidden opacity-0 transition-opacity duration-1000" :class="{ 'opacity-100': isVisible }">
    <div class="w-full container mx-auto px-4 grid md:grid-cols-2 gap-10 items-center">
      <div class="translate-y-10 opacity-0 transition-all duration-1000" :class="{ 'translate-y-0 opacity-100': isVisible }">
        ...
        <button class="mt-6 inline-flex items-center rounded-md bg-amber-500 hover:bg-amber-600 px-5 py-3 text-white shadow-md shadow-amber-200/40">
          View My Reel
        </button>
      </div>
      <div class="relative translate-y-10 opacity-0 transition-all duration-1000 delay-200" :class="{ 'translate-y-0 opacity-100': isVisible }">
        ...
        <div class="hidden md:flex flex-col gap-2 absolute left-2 top-2">
          <span class="w-8 h-8 bg-zinc-900/80 text-white rounded-md grid place-items-center text-xs">f</span>
          <span class="w-8 h-8 bg-zinc-900/80 text-white rounded-md grid place-items-center text-xs">ig</span>
          <span class="w-8 h-8 bg-zinc-900/80 text-white rounded-md grid place-items-center text-xs">yt</span>
        </div>
      </div>
    </div>
  </section>
